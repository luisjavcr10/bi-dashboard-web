...
import { getReporteDisponibilidad } from "@/lib/queries/reportes";
...
export async function GET(req: NextRequest) {
    try {
        ...
        const data = await getReporteDisponibilidad(filters);
        return NextResponse.json({ status: "ok", data });
    } catch (error) {
        console.error("Error fetching Disponibilidad report:", error);
